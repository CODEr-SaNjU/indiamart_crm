...
class CK_AccountForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
          ...
          'DATE_RE' : forms.DateInput(attrs={'class':'form-control','type':'date','id':'DATE_REid'}),
          'DATE_R' : forms.DateInput(attrs={'class':'form-control','type':'date','id':'DATE_Rid'}),
          'DATE_TIME_RE' : forms.DateTimeInput(attrs={'class':'form-control', 'type':'date', 'id':'DATE_TIME_REid'}),
